package com.itheima.travel.plugin;
...
public class LombokPlugin extends PluginAdapter {
    ...
    /**
     * @param warnings list of warnings 警告一览表
     * @return always true 总为 true
     */
    ...
    /**
     * Intercepts base record class generation 拦截基记录类的生成
     *
     * @param topLevelClass     the generated base record class 生成的基本记录类
     * @param introspectedTable The class containing information about the table as
     *                          introspected from the database 包含有关表的信息的类从数据库进行内省
     *
     * @return always true
     */
    @Override
    ...
    /**
     * Intercepts primary key class generation 拦截主键类的生成
     *
